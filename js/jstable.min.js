...
var JSTableDefaultConfig = { perPage: 5, perPageSelect: [5, 10, 15, 20, 25], sortable: !0, searchable: !0, nextPrev: !0, firstLast: !1, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", truncatePager: !0, pagerDelta: 2, classes: { top: "dt-top", info: "dt-info", input: "dt-input", table: "dt-table", bottom: "dt-bottom", search: "dt-search", sorter: "dt-sorter", wrapper: "dt-wrapper", dropdown: "dt-dropdown", ellipsis: "dt-ellipsis", selector: "dt-selector", container: "dt-container", pagination: "dt-pagination", loading: "dt-loading", message: "dt-message" }, labels: { placeholder: "Buscar...", perPage: "{select} Resultados por página", noRows: "No entries found", info: "Mostrar {start} até {end} de {rows} entradas  ", loading: "Carregando...", infoFiltered: "Showing {start} to {end} of {rows} entries (filtered from {rowsTotal} entries)" }, layout: { top: "{select}{search}", bottom: "{info}{pager}" }, serverSide: !1, deferLoading: null, ajax: null, ajaxParams: {} },
    JSTable = function() {
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                if (e && t.length) {
                    var a = t.replace("{start}", this.getDataCount() > 0 ? this._getPageStartIndex() + 1 : 0).replace("{end}", this._getPageEndIndex() + 1).replace("{page}", this.currentPage).replace("{pages}", this.pager.getPages()).replace("{rows}", this.getDataCount()).replace("{rowsTotal}", this.getDataCountTotal());
                    e.innerHTML = a
                }
            }
        }, { key: "_getPageStartIndex", value: function() { return (this.currentPage - 1) * this.config.perPage } }, { key: "_getPageEndIndex", value: function() { var e = this.currentPage * this.config.perPage - 1; return e > this.getDataCount() - 1 ? this.getDataCount() - 1 : e } }, { key: "_getData", value: function() { return this._emit("getData", this.table.dataRows), this.table.dataRows.filter((function(e) { return e.visible })) } }, {
            key: "_fetchData",
            value: function() {
                var e = this,
            ...
            value: function(e, t) {
                ...
                i.forEach((function(e) { e.removeClass("asc"), e.removeClass("desc") })), r.addClass(this.sortDirection), this.config.serverSide || (n = n.sort((function(e, t) {
            ...
            value: function() {
                ...
                })), this.config.searchable && this.wrapper.addEventListener("keyup", (function(t) { "INPUT" === t.target.nodeName && t.target.classList.contains(e.config.classes.input) && (t.preventDefault(), e.search(t.target.value)) }))
            }
        }, { key: "on", value: function(e, t) { this.events = this.events || {}, this.events[e] = this.events[e] || [], this.events[e].push(t) } }, { key: "off", value: function(e, t) { this.events = this.events || {}, e in this.events != !1 && this.events[e].splice(this.events[e].indexOf(t), 1) } }, {
            key: "_emit",
            value: function(e) {
    ...
    JSTableElement = function() {
        function e(t) { _classCallCheck(this, e), this.element = t, this.body = this.element.tBodies[0], this.head = this.element.tHead, this.rows = Array.from(this.element.rows).map((function(e) { return new JSTableRow(e, e.parentNode.nodeName) })), this.dataRows = this._getBodyRows(), this.header = this._getHeaderRow() }
        return _createClass(e, [{ key: "_getBodyRows", value: function() { return this.rows.filter((function(e) { return !e.isHeader && !e.isFooter })) } }, { key: "_getHeaderRow", value: function() { return this.rows.find((function(e) { return e.isHeader })) } }, { key: "getColumnCount", value: function() { return this.header.getColumnCount() } }, { key: "getFooterRow", value: function() { return this.rows.find((function(e) { return e.isFooter })) } }]), e
    }(),
    JSTableRow = function() {
        function e(t, a) { _classCallCheck(this, e), this.cells = Array.from(t.cells).map((function(e) { return new JSTableCell(e) })), this.d = this.cells.length, this.isHeader = "THEAD" === a, this.isFooter = "TFOOT" === a, this.visible = !0 }
        return _createClass(e, [{ key: "getCells", value: function() { return Array.from(this.cells) } }, { key: "getColumnCount", value: function() { return this.cells.length } }, { key: "getCell", value: function(e) { return this.cells[e] } }, { key: "getCellContent", value: function(e) { return this.getCell(e).getContent() } }, {
            key: "getFormated",
            value: function(e) {
        ...
        }, { key: "setCellContent", value: function(e, t) { this.cells[e].setContent(t) } }, { key: "setCellClass", value: function(e, t) { this.cells[e].setClassName(t) } }], [{
            key: "createFromData",
            value: function(t) {
    ...
    JSTableCell = function() {
        function e(t) {
            ...
            var a = this;
            this.attributes = {}, _toConsumableArray(t.attributes).forEach((function(e) { a.attributes[e.name] = e.value }))
        }
        return _createClass(e, [{ key: "getElement", value: function() { return this.element } }, { key: "getContent", value: function() { return this.content } }, { key: "setContent", value: function(e) { this.content = e } }, { key: "setClass", value: function(e) { this.className = e } }, { key: "setSortable", value: function(e) { this.isSortable = e } }, { key: "addClass", value: function(e) { this.classes.push(e) } }, { key: "removeClass", value: function(e) { this.classes.indexOf(e) >= 0 && this.classes.splice(this.classes.indexOf(e), 1) } }]), e
    }(),
    JSTablePager = function() {
        function e(t) { _classCallCheck(this, e), this.instance = t }
        return _createClass(e, [{ key: "getPages", value: function() { var e = Math.ceil(this.instance.getDataCount() / this.instance.config.perPage); return 0 === e ? 1 : e } }, {
            key: "render",
            value: function() {
                ...
                if (t > 1) {
                    ...
                    e.firstLast && a.appendChild(this.createItem("pager", 1, e.firstText)), e.nextPrev && a.appendChild(this.createItem("pager", s, e.prevText)), this.truncate().forEach((function(e) { a.appendChild(e) })), e.nextPrev && a.appendChild(this.createItem("pager", r, e.nextText)), e.firstLast && a.appendChild(this.createItem("pager", t, e.lastText))
                }
                return a
            }
        }, { key: "createItem", value: function(e, t, a, s) { var r = document.createElement("li"); return r.className = e, r.innerHTML = s ? "<span>" + a + "</span>" : '<a href="#" data-page="' + t + '">' + a + "</a>", r } }, { key: "isValidPage", value: function(e) { return e > 0 && e <= this.getPages() } }, {
            key: "truncate",
            value: function() {
                var e, t = this,
                    a = t.instance.config,
                ...
                if (this.instance.config.truncatePager) {
                    ...
                    l.forEach((function(s) { e && (s - e == 2 ? c.push(t.createItem("", e + 1, e + 1)) : s - e != 1 && c.push(t.createItem(a.classes.ellipsis, 0, a.ellipsisText, !0))), c.push(t.createItem(s == r ? "active" : "", s, s)), e = s }))
                } else
